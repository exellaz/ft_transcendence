...
//    ball.dx =
//      scoredSide === "left" ? -room.setting.ballSpeed : room.setting.ballSpeed;
...
//    return Math.max(
//      0,
//      Math.min(gameHeight - paddleHeight, current + dy * paddleSpeed),
//    );
//  }
...
//    // Bounce off paddles
//    for (const clientId in room.gameState.paddles) {
//      //look for player id in paddles
//      const paddleY = room.gameState.paddles[clientId];
//      if (!paddleY) continue;
//      //check left is belong this player or not
//      const clientIdNum = parseInt(clientId, 10);
//      if (
//        room.gameState.teams.left.some(
//          (p: playerInfo) => p.clientId === clientIdNum,
//        ) &&
//        ball.x - ballSize <= paddleWidth
//      ) {
//        if (
...
//      }
//      if (
//        room.gameState.teams.right.some(
//          (p: playerInfo) => p.clientId === clientIdNum,
//        ) &&
...
//      console.log(
//        `Score: Left ${room.gameState.score.left} - Right ${room.gameState.score.right}`,
//      ); //// debug
...
//    if (
//      room.gameState.score.left >= room.setting.scorePoint ||
//      room.gameState.score.right >= room.setting.scorePoint
//    ) {
