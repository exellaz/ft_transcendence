...
export interface GetTournamentHistoryResponse extends ApiResponse<TournamentHistory[]> {}
...
export interface GetTournamentStatsResponse extends ApiResponse<TournamentStats> {}